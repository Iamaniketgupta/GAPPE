...
const DynamicDrawer = ({collapse, setCollapse}) => {
    ...
    return (
        <div className={`${collapse ? 'absolute translate-x-[-100%]' : 'translate-x-0'}  shadow-lg dark:bg-stone-800 min-h-full max-h-screen p-3 md:p-5 rounded-t-3xl flex  min-w-full md:min-w-[350px]  md:max-w-[400px] transition-all ease-linear duration-75`}>
